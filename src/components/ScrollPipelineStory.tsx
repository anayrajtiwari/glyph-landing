...
export const ScrollPipelineStory: React.FC = () => {
  ...
  return (
    <section ref={containerRef} id="pipeline" className="py-32 bg-[#0a0d14] relative border-b border-[#232a3b] overflow-hidden">
      {/* Ambient background glow spheres */}
      <motion.div
        animate={{ scale: [1, 1.2, 1], opacity: [0.15, 0.3, 0.15] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-950/25 rounded-full blur-[160px] pointer-events-none"
      />
      <motion.div
        animate={{ scale: [1.2, 1, 1.2], opacity: [0.15, 0.25, 0.15] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-orange-950/20 rounded-full blur-[160px] pointer-events-none"
      />
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-28 relative z-10">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-950/60 border border-cyan-800/40 text-cyan-400 text-xs font-mono-code"
          >
          ...
          <p className="text-slate-400 text-base font-light">
            Scroll down to watch the compiler lex, lower, morph, and emit Next.js 16/26 targets in real time.
          </p>
        ...
        <div className="relative space-y-32">
          ...
          <motion.div
            ...
            className="absolute left-6 md:left-1/2 -translate-x-1/2 top-4 w-1 bg-gradient-to-b from-cyan-400 via-emerald-400 to-orange-400 rounded-full shadow-[0_0_15px_#06b6d4] pointer-events-none"
          />
          ...
          >
            ...
            <div className="w-full md:w-1/2 pl-16 md:pl-12">
              <motion.div
                ...
                className="p-6 rounded-xl bg-[#121722] border border-cyan-500/40 font-mono-code text-xs space-y-3 shadow-2xl relative overflow-hidden"
              >
          ...
          >
            ...
            <div className="w-full md:w-1/2 pl-16 md:pl-0 md:pr-12">
              <motion.div
                ...
                className="p-6 rounded-xl bg-[#121722] border border-emerald-500/40 font-mono-code text-xs space-y-4 shadow-2xl relative overflow-hidden"
              >
                <div className="flex items-center justify-between border-b border-[#232a3b] pb-2 text-[11px] text-slate-500">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <motion.div
                    ...
                    className="p-3.5 rounded bg-[#0a0d14] border border-emerald-500/30 space-y-1"
                  >
                  ...
                  <motion.div
                    ...
                    className="p-3.5 rounded bg-[#0a0d14] border border-cyan-500/30 space-y-1"
                  >
          ...
          >
            ...
            <div className="w-full md:w-1/2 pl-16 md:pl-12">
              <motion.div
                whileHover={{ scale: 1.03 }}
                className="rounded-xl border border-orange-500/50 bg-[#0a0d14] p-6 shadow-2xl space-y-4"
              >
            ...
            <div className="w-full md:w-1/2 pl-16 md:pl-0 md:pr-12">
              <div className="space-y-4 font-mono-code text-xs">
                <motion.div
                  ...
                  className="p-4.5 rounded-xl bg-[#121722] border border-cyan-500/50 space-y-2 shadow-xl"
                >
                ...
                <motion.div
                  ...
                  className="p-4.5 rounded-xl bg-[#121722] border border-orange-500/50 space-y-2 shadow-xl"
                >
                ...
                <motion.div
                  ...
                  className="p-4.5 rounded-xl bg-[#121722] border border-emerald-500/50 space-y-2 shadow-xl"
                >
          ...
          <motion.div
            ...
            className="relative flex flex-col items-center text-center space-y-6 pt-12 z-20"
          >
            <motion.div
              animate={{ rotate: [0, 360] }}
              transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
              className="w-28 h-28 rounded-3xl bg-[#121722] border-2 border-cyan-400 flex items-center justify-center shadow-[0_0_40px_rgba(6,182,212,0.35)]"
            >
              <GlyphLogo size={56} glow />
            </motion.div>
